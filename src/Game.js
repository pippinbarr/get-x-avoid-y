...
var MADNESS = 0;
var MADNESS_MIN_LEVELS = 10;
var MADNESS_INCREMENT = 0.05;
...
BasicGame.Game.prototype = {
    ...
    setupBG: function ()
    {
        ...
        else
        {
            ...
            bg_trans = bgGroup.create(0,0,'transparency_bg.png');
    ...
    setupEmitter: function (particleIndex,particleTypeStringIndex)
    {
        ...
        {
            // frameNames = ["default_particle.png"];
            emitter.makeParticles(['default_particle.png']);
        }
        else
        {
            // Now add the particles to the emitter
            emitter.makeParticles(this.getAtlas(particleIndex),frameNames);
        }
    ...
    makeSprite: function (theX,theY,theGameIndex,theImageTypeIndex,theGroup,forceFrameRate)
    {
        ...
        theSprite = theGroup.create(0,0,this.getAtlas(theGameIndex),theName + '/' + imageTypeStrings[theImageTypeIndex] + '_1.png');
    ...
    setupUI: function ()
    {
        ...
        startBG = uiGroup.create(0,0,'black_pixel.png');
    ...
    startTheGame: function ()
    {
        ...
        timerBar = this.game.add.sprite(0,0,'red_pixel.png');
        timerBar.scale.y = 10;
    ...
    addItem: function (typeGroup,typeIndex,typeStringIndex,typeString)
    {
        ...
        if (gamesData[typeIndex].nopixelperfect == undefined)
        {
    ...
    getAtlas: function (theIndex)
    {
        return 'atlas' + gamesData[theIndex].atlas;
    }
};
