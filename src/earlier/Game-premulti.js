...
BasicGame.Game.prototype = {
    ...
    setupBG: function () 
    {
        ...
        else
        {
            ...
            bg_trans = bgGroup.create(0,0,'gameAtlas','transparency_bg.png');
    ...
    makeSprite: function (theX,theY,theGameIndex,theImageTypeIndex,theGroup,forceFrameRate) 
    {
        ...
        theSprite = theGroup.create(0,0,'gameAtlas',theName + '/' + imageTypeStrings[theImageTypeIndex] + '_1.png');
    ...
    startTheGame: function () 
    {
        ...
        timerBar = this.game.add.sprite(0,0,'gameAtlas','red_pixel.png');
        timerBar.scale.y = 10;
