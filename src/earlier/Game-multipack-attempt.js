...
BasicGame.Game.prototype = {
    ...
    setupBG: function () 
    {
        ...
        else
        {
            ...
            bg_trans = bgGroup.create(0,0,this.getAtlasName('transparency_bg.png'),'transparency_bg.png');
    ...
    setupEmitter: function (particleIndex,particleTypeStringIndex)
    {
        ...
        {
            frameNames.push(theName + '/' + imageTypeStrings[particleTypeStringIndex] + '_' + j + '.png')
        }
        ...
        emitter.makeParticles('gameAtlas',frameNames);      
    ...
    makeSprite: function (theX,theY,theGameIndex,theImageTypeIndex,theGroup,forceFrameRate) 
    {
        ...
        spritePathNoSuffix = theName + '/' + imageTypeStrings[theImageTypeIndex];

        theSprite = theGroup.create(0,0,this.getAtlasName(spritePathNoSuffix + '_1' + '.png'),spritePathNoSuffix + '_1.png');
        ...
        {
            frameNames.push(theName + '/' + imageTypeStrings[theImageTypeIndex] + '_' + j + '.png')
        }
    ...
    setupUI: function () 
    {
        ...
        startBG = uiGroup.create(0,0,'gameAtlas','black_pixel.png');
    ...
    startTheGame: function () 
    {
        ...
        timerBar = this.game.add.sprite(0,0,this.getAtlasName('red_pixel.png'),'red_pixel.png');
        timerBar.scale.y = 10;
    ...
    getAtlasName: function (theFile)
    {
        console.log("Looking for: " + theFile);

        for (var i = 0; i <= NUM_ATLASES; i++)
        {
            theJSON = this.game.cache.getJSON('gameAtlasJSON' + i);

            if (theJSON.frames[theFile] != undefined)
            {
                console.log("Returning: gameAtlas" + i);
                return 'gameAtlas' + i;
            }
        }

        console.log("Couldn't find an atlas!!");
        return '';
    },
};
